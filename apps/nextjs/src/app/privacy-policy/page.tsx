  ...
  return (
    <div className='max-w-2xl py-20'>
      ...
      <p>
        ...
        information. This Privacy Policy is intended to inform you about how we collect, use, and disclose information when you use our Service, even
        though we do not collect any user data.
      </p>
      <br />
      ...
      <ol className='list-inside list-decimal space-y-4 py-3'>
        ...
        <li>
          <b>Device Information:</b> We do not collect information about the device you use to access our Service, such as the device type, operating
          system, or browser information.
        </li>
      ...
      <p>
        If you have any questions or concerns about this Privacy Policy or the way we handle your data (which is none, as we do not collect any data),
        please contact us at avicharlop [at] gmail.com.
      </p>
      <br />
      <p>
